...
MY_API_KEY = '9402c816fef64d588b289aba6c14e6b8'
...
def airchart():
        ...
        air_url = air_url_template.format(lat=my_latitude, lng=my_longitude, API_KEY=app.config['9402c816fef64d588b289aba6c14e6b8'], start=my_start, end=my_end)
